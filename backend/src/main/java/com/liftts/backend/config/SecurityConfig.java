package com.liftts.backend.config;
...
//                              .requestMatchers(HttpMethod.POST, "/api/v1/auth/**").permitAll()
    ...
    CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(Arrays.asList("https://liftts.app", "https://www.liftts.app", "http://localhost:3001", "http://localhost:3000"));
